...
::: {layout="[[42, 16, 42], [42, 16, 42], [42, 16, 42], [42, 16, 42]]" layout-valign="center"}
![](output/ex_stacked_bar.png){height="130px"}

[{{< fa arrow-right size=2x >}}]{.graph-arrow}

![](output/alt_line.png){height="130px"}

![](output/ex_bar_errorbars.png){height="130px"}

[{{< fa arrow-right size=2x >}}]{.graph-arrow}

![](output/species_resistance_beeswarm.png){height="130px"}

![](output/antibiotic_consumption_bad_errorbars.png){height="130px"}

[{{< fa arrow-right size=2x >}}]{.graph-arrow}

![](output/alt_ribbon.png){height="130px"}

![](output/stewardship_bad_clustered_bar.png){height="130px"}

[{{< fa arrow-right size=2x >}}]{.graph-arrow}

![](output/alt_diverging_stacked_bar.png){height="130px"}
:::
